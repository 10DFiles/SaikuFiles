...
(c._options.batchSize=1E3);a=c.internalRender(c._data,c._options);$(c._options.htmlObject).html(a);_.defer(function(a){if(c._options.hasOwnProperty("batch")&&c._options.hasBatchResult){var b=0,d=!1,h=c._options.hasOwnProperty("batchIntervalSize")?c._options.batchIntervalSize:20;a=c._options.hasOwnProperty("batchIntervalTime")?c._options.batchIntervalTime:20;var k=c._options.batchResult.length,m=_.debounce(function(){if(!d&&0<k&&b<k){d=!0;for(var a="",e=b,m=0;b<k&&m<h;m++,b++)a+=c._options.batchResult[b];
b>e&&$(c._options.htmlObject).append($(a));d=!1}b>=k&&$(c._options.htmlObject).parent().parent().unbind("scroll")},a);$(c._options.htmlObject).parent().parent().scroll(function(){m()})}});return a});else return this.internalRender(this._data,c._options)};SaikuTableRenderer.prototype.clear=function(a,b){this._options&&this._options.htmlObject&&this._options.hasOwnProperty("batch")&&$(this._options.htmlObject).parent().parent().unbind("scroll")};
...
function genTotalHeaderCells(a,b,c,d,e,f){for(var g="",h=b;0<=h;h--)if(a==c[h]){var k=e[h][d[h]],m;m=0==h&&1==b?"col":h==b?"col_total_corner":h==b-1&&k.captions?"col_total_first":"col_null";for(var l=0;l<k.cells.length;l++){var s="\x26nbsp;";b==e.length-1&&(k.captions&&(s=e[h][d[h]].captions[l]),0==h&&0==d[h]&&(s=k.captions?s+"\x26nbsp;":"",s+=f?"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e":"Grand Total"));g+='\x3cth class\x3d"'+m+'"\x3e'+(f?"\x3cdiv\x3e"+s+"\x3c/div\x3e":s)+"\x3c/th\x3e"}d[h]++;
...
function genTotalHeaderRowCells(a,b,c,d,e){for(var f=d[COLUMNS],g=b[COLUMNS],h=c[COLUMNS],k=f.length-2,m="",l=k;0<=l;l--)if(a==g[l]){for(var s=0;s<f[l][h[l]].cells.length;s++){m+="\x3ctr\x3e";for(b=0;b<=k;b++){var q="\x26nbsp;";c=0==l&&0==b?"row":l==b+1?"row_total_corner":l==b&&f[l][h[l]].captions?"row_total_first":l<b+1?"row_total":"row_null";b==k&&(f[l][h[l]].captions&&(q=f[l][h[l]].captions[s]),0==l&&0==h[l]&&(q=f[l][h[l]].captions?q+"\x26nbsp;":"",q+=e?"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e":
"Grand Total"));m+='\x3cth class\x3d"'+c+'"\x3e'+(e?"\x3cdiv\x3e"+q+"\x3c/div\x3e":q)+"\x3c/th\x3e"}c={};b={};for(q=0;q<d[ROWS].length;q++)c[q]=0,b[q]=d[ROWS][q][c[q]].width;for(q=0;q<f[l][h[l]].cells[s].length;q++)m+='\x3ctd class\x3d"data total"\x3e'+f[l][h[l]].cells[s][q].value+"\x3c/td\x3e",m+=totalIntersectionCells(q+1,d[ROWS].length-1,b,c,d[ROWS]);m+="\x3c/tr\x3e"}h[l]++;h[l]<f[l].length&&(g[l]+=f[l][h[l]].width)}return m}var ROWS="ROWS",COLUMNS="COLUMNS";
...
SaikuTableRenderer.prototype.internalRender=function(a,b){var c="",d="",e=a.cellset,f=e?e:[],g,h,k,m,l,s=0,q=[],x=null,t=!1,v=!1,z=!1,y=[],A=!0;b&&(x=b.hasOwnProperty("batchSize")?b.batchSize:null,A=b.hasOwnProperty("wrapContent")?b.wrapContent:!0);var r={};r[COLUMNS]=a.rowTotalsLists;r[ROWS]=a.colTotalsLists;for(var D={},B={},v=[ROWS,COLUMNS],d=0;d<v.length;d++)D[v[d]]=[],B[v[d]]=[];if(r[COLUMNS])for(d=0;d<r[COLUMNS].length;d++)B[COLUMNS][d]=0,D[COLUMNS][d]=r[COLUMNS][d][B[COLUMNS][d]].width;for(var p=
0,G=f.length;p<G;p++){var H=p-a.topOffset;g=1;var I=v=m=h=!1;if(r[ROWS])for(d=0;d<r[ROWS].length;d++)B[ROWS][d]=0,D[ROWS][d]=r[ROWS][d][B[ROWS][d]].width;d="\x3ctr\x3e";0===p&&(d="\x3cthead\x3e"+d);for(var u=0,J=f[p].length;u<J;u++){var F=u-a.leftOffset,n=e[p][u];"COLUMN_HEADER"===n.type&&(v=!0);if("COLUMN_HEADER"===n.type&&"null"===n.value&&(null==k||u<k))d+='\x3cth class\x3d"all_null"\x3e\x26nbsp;\x3c/th\x3e';else if("COLUMN_HEADER"===n.type){null==k&&(k=u);f[p].length==u+1?m=!0:l=e[p][u+1];if(m)"null"==
n.value?d+='\x3cth class\x3d"col_null"\x3e\x26nbsp;\x3c/th\x3e':(r[ROWS]&&(g=r[ROWS][p+1][B[ROWS][p+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+g+'" title\x3d"'+n.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+p+":"+u+'"\x3e'+n.value+"\x3c/div\x3e":n.value)+"\x3c/th\x3e");else{var F=1<u&&1<p&&!h&&u>k?e[p-1][u+1].value!=e[p-1][u].value||e[p-1][u+1].properties.uniquename!=e[p-1][u].properties.uniquename:!1,C=999<g?!0:!1;n.value!=l.value||nextParentsDiffer(e,p,u)||h||F||C?("null"==
n.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x26nbsp;\x3c/th\x3e':(r[ROWS]&&(g=r[ROWS][p+1][B[ROWS][p+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+(0==g?1:g)+'" title\x3d"'+n.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+p+":"+u+'"\x3e'+n.value+"\x3c/div\x3e":n.value)+"\x3c/th\x3e"),g=1):g++}r[ROWS]&&(d+=genTotalHeaderCells(u-a.leftOffset+1,p+1,D[ROWS],B[ROWS],r[ROWS],A))}else if("ROW_HEADER"===n.type&&"null"===n.value)d+='\x3cth class\x3d"row_null"\x3e\x26nbsp;\x3c/th\x3e';
else if("ROW_HEADER"===n.type){s==u?h=!0:l=e[p][u+1];F=e[p-1];C=!I&&!h&&(0==u||!topParentsDiffer(e,p,u))&&n.value===F[u].value;I=!C;F=C?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+p+":"+u+'"\x3e'+n.value+"\x3c/div\x3e";A||(F=C?"\x26nbsp;":n.value);var C=C?"row_null":"row",E=0;if(!h&&("undefined"==typeof l||"null"===l.value)){var E=1,w=n.properties.dimension,n=n.properties.level,n=w in q?q[w].length-q[w].indexOf(n):1,w=u+1;for(;E<n&&w<=s+1&&"null"!==e[p][w];w++)E=w-u;u=u+E-1}d+='\x3cth class\x3d"'+
C+'" '+(0<E?' colspan\x3d"'+E+'"':"")+"\x3e"+F+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===n.type)d+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+n.value+"\x3c/div\x3e":n.value)+"\x3c/th\x3e",h=!0,s=u,n.properties.hasOwnProperty("dimension")&&(w=n.properties.dimension,w in q||(q[w]=[]),q[w].push(n.properties.level));else if("DATA_CELL"===n.type){t=!0;C="";w=n.value;E="";if(n.properties.hasOwnProperty("image"))var w=n.properties.hasOwnProperty("image_height")?" height\x3d'"+n.properties.image_height+
"'":"",K=n.properties.hasOwnProperty("image_width")?" width\x3d'"+n.properties.image_width+"'":"",w="\x3cimg "+w+" "+K+" style\x3d'padding-left: 5px' src\x3d'"+n.properties.image+"' border\x3d'0'\x3e";n.properties.hasOwnProperty("style")&&(C=" style\x3d'background-color: "+n.properties.style+"' ");n.properties.hasOwnProperty("link")&&(w="\x3ca target\x3d'__blank' href\x3d'"+n.properties.link+"'\x3e"+w+"\x3c/a\x3e");n.properties.hasOwnProperty("arrow")&&(E="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+
n.properties.arrow+".gif' border\x3d'0'\x3e");d+='\x3ctd class\x3d"data" '+C+"\x3e"+(A?'\x3cdiv class\x3d"datadiv" alt\x3d"'+n.properties.raw+'" rel\x3d"'+n.properties.position+'"\x3e':"")+w+E+(A?"\x3c/div\x3e":"")+"\x3c/td\x3e";r[ROWS]&&(d+=genTotalDataCells(F+1,H,D[ROWS],B[ROWS],r,A))}}d+="\x3c/tr\x3e";g="";r[COLUMNS]&&0<=H&&(g+=genTotalHeaderRowCells(H+1,D,B,r,A));t&&x?p<=x?(v||z||(c+="\x3c/thead\x3e\x3ctbody\x3e",z=!0),c+=d,0<g.length&&(c+=g)):(y.push(d),0<g.length&&y.push(g)):(v||z||(c+="\x3c/thead\x3e\x3ctbody\x3e",
z=!0),c+=d,0<g.length&&(c+=g))}b&&(b.batchResult=y,b.hasBatchResult=0<y.length);return"\x3ctable\x3e"+c+"\x3c/tbody\x3e\x3c/table\x3e"};
...
this.get("key"),JSON.stringify(this));return a}}),DataSources=Backbone.Model.extend({url:"admin/attacheddatasources",initialize:function(a,b){b&&b.dialog&&(this.dialog=b.dialog)},parse:function(a){this.dialog&&this.dialog.callback(a)}}),DimensionList=Backbone.View.extend({events:{"click span":"select","click a":"select","click .parent_dimension ul li a.level":"select_dimension","click .measure":"select_measure","click .addMeasure":"measure_dialog"},initialize:function(a){_.bindAll(this,"render","load_dimension",
...
this.members_search_server=this.available_members.length>=this.members_limit||0==this.available_members.length;c.show_unique_option=!1;$(this.el).find(".options #show_unique").attr("checked",!1);if(0<this.workspace.query.helper.getCalculatedMembers().length)for(var d=this.get_calcmembers(),e=d.length,f=0;f<e;f++){var g=c.workspace.query.helper.getCalculatedMembers(),h=!1;g&&0<g.length&&_.each(g,function(a){a.uniqueName===d[f].uniqueName&&(h=!0)});this.available_members.push({obj:d[f],calc:h})}$(this.el).find(".items_size").text(this.available_members.length);
this.members_search_server?$(this.el).find(".warning").text("More items available than listed. Pre-Filter on server."):$(this.el).find(".warning").text("");e=c.member.level;(g=c.workspace.query.helper.getHierarchy(c.member.hierarchy))&&g.levels.hasOwnProperty(e)&&(this.selected_members=[],g.levels[e].selection&&_.each(g.levels[e].selection.members,function(a){var b=c.workspace.query.helper.getCalculatedMembers(),d=!1;b&&0<b.length&&_.each(b,function(b){b.uniqueName===a.uniqueName&&(d=!0)});c.selected_members.push({obj:a,
calc:d})}),this.selection_type=g.levels[e].selection?g.levels[e].selection.type:"INCLUSION");for(var k=[],g=0,e=this.selected_members.length;g<e;g++)k.push(this.selected_members[g].obj.caption);0==$(this.el).find(".used_selections .selection_options li.option_value").length&&(g=$(this.el).find(".used_selections .selection_options"),g.empty(),e=_.template($("#template-selections-options").html())({options:this.selected_members}),$(g).html(e));this.available_members=_.select(this.available_members,
function(a){return-1===k.indexOf(a.obj.caption)});0<this.available_members.length&&(g=$(this.el).find(".available_selections .selection_options"),g.empty(),e=_.template($("#template-selections-options").html())({options:this.available_members}),$(g).html(e));0<$(c.el).find(".selection_options.ui-selectable").length&&$(c.el).find(".selection_options").selectable("destroy");$(c.el).find(".selection_options").selectable({distance:20,filter:"li",stop:function(a,b){$(c.el).find(".selection_options li.ui-selected input").each(function(a,
b){b&&b.hasAttribute("checked")?b.checked=!0:$(b).attr("checked",!0);$(b).parents(".selection_options").find("li.all_options input").prop("checked",!0)});$(c.el).find(".selection_options li.ui-selected").removeClass("ui-selected")}});$(this.el).find(".filterbox").autocomplete({minLength:1,delay:200,appendTo:".autocomplete",source:function(a,b){var d=0==c.show_unique_option?"caption":"name",e=$.map(c.available_members,function(b){if(-1<b[d].toLowerCase().indexOf(a.term.toLowerCase()))return{label:0==
c.show_unique_option?b.caption:b.uniqueName,value:0==c.show_unique_option?b.uniqueName:b.caption}});b(e)},select:function(a,b){encodeURIComponent(b.item.value);var d=b.item.label,e=0==c.show_unique_option?b.item.value:b.item.label,f=0==c.show_unique_option?b.item.label:b.item.value;$(c.el).find('.available_selections .selection_options input[value\x3d"'+encodeURIComponent(e)+'"]').parent().remove();$(c.el).find('.used_selections .selection_options input[value\x3d"'+encodeURIComponent(e)+'"]').parent().remove();
...
(a.workspace.query.helper.removeAllLevelCalculatedMember(c),$(this.el).find(".used_selections .option_value input").each(function(b,f){var g=$(f).val();if($(f).hasClass("cmember")){var l=$(f).attr("label");a.workspace.toolbar.group_parents();a.workspace.query.helper.includeLevelCalculatedMember(a.axis,c,d,decodeURIComponent(g),0);e.push({uniqueName:decodeURIComponent(g),caption:decodeURIComponent(l),type:"calculatedmember"})}else l=$(f).attr("label"),e.push({uniqueName:decodeURIComponent(g),caption:decodeURIComponent(l)})}));
...
selectDimension:a,dimension:c,hierarchy:b,uniqueName:this.pmUniqueName,lastLevel:this.pmLevel,breadcrumbs:this.pmBreadcrumbs,select_type:"select_member",selected_member:this.selected_member,close_callback:function(a){e.close_select_modal(d,a)}})).render().open();this.$el.parents(".ui-dialog").find(".ui-dialog-title").text("Custom Filter")},close_select_modal:function(a,b){a.insert(b)},help:function(){window.open("http://wiki.meteorite.bi/display/SAIK/Filtering")}}),StringFilterModal=Modal.extend({type:"filter",
closeText:"Save",events:{"click .dialog_footer a":"call","click .insert-member":"open_select_member_selector","click .remove_row":"remove_row","click .or":"add_text_box"},buttons:[{text:"Add",method:"save"},{text:"Close",method:"update"},{text:"Help",method:"help"}],message:"",expression_text:function(){return"\x3cform class\x3d'form-group-inline' data-action\x3d'cad' id\x3d'custom_filter'\x3e\x3ctable border\x3d'0px'\x3e\x3ctr\x3e\x3ctd class\x3d'col1'\x3e\x3clabel\x3eSelect Level:\x3cselect class\x3d'levellist form-control'\x3e\x3c/select\x3e\x3c/label\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd class\x3d'col1'\x3e\x3clabel\x3eMatch Type:\x3cselect class\x3d'form-control match_type'\x3e\x3coption value\x3d'EQUALS'\x3eEqual To\x3c/option\x3e\x3coption value\x3d'NOTEQUAL'\x3eNot Equal To\x3c/option\x3e\x3coption value\x3d'LIKE'\x3eLike\x3c/option\x3e\x3coption value\x3d'NOTLIKE'\x3eNot Like\x3c/option\x3e\x3c/select\x3e\x3c/label\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'match_label'\x3e\x3ctd class\x3d'col1'\x3e\x3clabel\x3eMatch Text:\x3cinput class\x3d'form-control text_input'/\x3e\x3c/label\x3e\x3ca href\x3d'#' class\x3d'or'\x3eOR\x3c/a\x3e\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3chr/\x3e\x3ctable class\x3d'existing_filters'\x3e\x3c/table\x3e\x3c/form\x3e"},
expression:" ",expressonType:"",initialize:function(a){this.id=_.uniqueId("match-modal-");this.workspace=a.workspace;this.axis=a.axis;this.query=a.query;this.success=a.success;this.expression=a.expression;this.expressionType=a.expressionType;_.bindAll(this,"save","expression_text");_.extend(this.options,{title:"Custom "+this.expressionType+" for "+this.axis});this.message=this.expression_text(this.expressionType);this.bind("open",function(){this.populate_select();this.populate_existing()});if(isIE&&
9>isIE)$(this.el).find("form").on("submit",this.save)},populate_select:function(){var a=this.workspace.query.helper.getAxis(this.axis);$(a.hierarchies).each(function(a,c){var d;d=""+('\x3coption value\x3d"'+c.name+'"\x3e'+c.name+"\x3c/option\x3e");$(".levellist").append(d)})},populate_existing:function(){$(".existing_filters tr").remove();var a=this.workspace.query.helper.getAxis(this.axis);_.each(a.filters,function(a,c){var d="",d="NameLike"===a.flavour&&"NOTEQUAL"===a.operator?"Not Like":"NameLike"!==
a.flavour||"LIKE"!==a.operator&&null!==a.operator?"Name"!==a.flavour||"EQUAL"!==a.operator&&null!==a.operator?"Does Not Equal":"Equals":"Like",e="",f="";_.each(a.expressions,function(a,b){0==b?e=a:a!=e&&(f+=a+" OR ")});f=f.substring(0,f.length-3);d="\x3ctr\x3e\x3ctd class\x3d'expr0'\x3e"+a.expressions[0]+"\x3c/td\x3e\x3ctd class\x3d'op' data-filter\x3d'"+a.operator+"'\x3e"+d+"\x3c/td\x3e\x3ctd class\x3d'expr1' data-expr\x3d'"+a.expressions+"'\x3e"+f+"\x3c/td\x3e\x3ctd class\x3d'remove_row'\x3ex\x3c/td\x3e\x3c/tr\x3e";
$(".existing_filters").append(d)})},save:function(a){a.preventDefault();var b=this;this.member=$(this.el).find(".levellist").find(":selected").val();this.matchtype=$(this.el).find(".match_type").find(":selected").val();this.expression=[];_.each($(this.el).find(".text_input"),function(a){""!=$(a).val()&&b.expression.push($(a).val())});b.success(this.member,this.matchtype,this.expression);this.populate_existing();$(".text_input").val("");return!1},error:function(){$(this.el).find("dialog_body").html("Could not add new folder")},
help:function(){window.open("http://wiki.meteorite.bi")},remove_row:function(a){a.preventDefault();var b=$(a.target),c=this.workspace.query.helper.getAxis(this.axis),d=this;_.each(c.filters,function(a,f){var g=b.closest("tr").find(".expr1").data("expr");a.expressions[0]===b.closest("tr").find(".expr0").html()&&a.expressions.join()===g&&a.operator===b.closest("tr").find(".op").data("filter")&&(c.filters=c.filters.splice(f+1,1),d.populate_existing())})},add_text_box:function(a){a.preventDefault();$(".match_label").parent().append("\x3ctr class\x3d'match_label'\x3e\x3ctd class\x3d'col1'\x3e\x3clabel\x3eMatch Text:\x3cinput class\x3d'text_input form-control'/\x3e\x3c/label\x3e\x3ca href\x3d'#' class\x3d'or'\x3eOR\x3c/a\x3e\x3c/td\x3e\x3c/tr\x3e")},
update:function(){this.close();this.workspace.query.run()}}),CustomFilterModal=Modal.extend({type:"filter",closeText:"Save",events:{"submit form":"save","change .function":"switch_function","change .type":"switch_type","click .dialog_footer a":"call"},buttons:[{text:"OK",method:"save"},{text:"Cancel",method:"close"}],message:"\x3cform id\x3d'custom_filter'\x3e\x3ctable border\x3d'0px'\x3e\x3ctr\x3e\x3ctd class\x3d'col0'\x3eDefine Filter\x3cselect class\x3d'form-control function'\x3e\x3coption\x3eSelect a Function...\x3c/option\x3e\x3coption value\x3d'TopCount'\x3eTopCount\x3c/option\x3e\x3coption value\x3d'TopPercent'\x3eTopPercent\x3c/option\x3e\x3coption value\x3d'TopSum'\x3eTopSum\x3c/option\x3e\x3coption value\x3d'BottomCount'\x3eBottomCount\x3c/option\x3e\x3coption value\x3d'BottomPercent'\x3eBottomPercent\x3c/option\x3e\x3coption value\x3d'BottomSum'\x3eBottomSum\x3c/option\x3e\x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide'\x3e\x3ctd\x3e\x3cspan class\x3d'ntype'\x3e\x3c/span\x3e\x3cinput class\x3d'n form-control' /\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide'\x3e\x3ctd\x3eSort by\x3cselect class\x3d'type form-control'\x3e\x3coption value\x3d'measure'\x3eMeasure\x3c/option\x3e\x3coption value\x3d'custom'\x3eMDX Expression\x3c/option\x3e\x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide sortingoption'\x3e\x3ctd\x3e\x26nbsp; \x26nbsp;\x3c/td\x3e\x3c/table\x3e\x3c/form\x3e",
...
h=this.$el.find("#cms-format option:selected").val(),k=this.$el.find(".form-group-inline").data("action"),m="",h="custom"===h?this.$el.find("#cms-format-custom").val():this.$el.find("#cms-format option:selected").val();"undefined"!==typeof b&&""!==b&&b||(m+="You have to enter a name for the member! ");"undefined"!==typeof c&&""!==c&&c||(m+="You have to enter a MDX formula for the calculated member! ");"undefined"!==typeof d&&""!==d&&d||(m+="You have to choose a dimension for the calculated member! ");
""!==m?alert(m):("calcmeasure"===g?(c={name:b,formula:c,properties:{},uniqueName:b,hierarchyName:d},h&&(c.properties.FORMAT_STRING=h),"cad"===k?(this.workspace.query.helper.addCalculatedMeasure(c),this.workspace.sync_query()):(this.workspace.query.helper.editCalculatedMeasure(a,c),this.workspace.sync_query(),this.workspace.drop_zones.set_measures())):(c={name:b,dimension:f,uniqueName:"["+e+"].["+b+"]",caption:b,properties:{},formula:c,hierarchyName:d,parentMember:"",parentMemberLevel:"",previousLevel:"",
...
"["+e+"].["+a+"]"),this.workspace.query.helper.editCalculatedMember(a,c),this.workspace.sync_query(),this.workspace.drop_zones.set_measures())),this.$el.dialog("close"))},populate_function_list:function(a){a=[{name:"Formula Not Empty Check",example:"Iif(NOT ISEMPTY([Measures].[My Measure]),([Measures].[My Measure] + [Numeric Expression]),null))",description:"Insert a formula with an ISEMPTY check to ensure that only non null cells are calculated",doc_link:"http://wiki.meteorite.bi/display/SAIK/Non+Empty+Calculated+Members"},
{name:"Aggregate",example:"Aggregate(Set_Expression [ ,Numeric_Expression ])",description:"Returns a number that is calculated by aggregating over the cells returned by the set expression.",doc_link:"https://msdn.microsoft.com/en-us/library/ms145524.aspx"},{name:"Avg",example:"Avg( Set_Expression [ , Numeric_Expression ] )",description:"Evaluates a set and returns the average of the non empty values of the cells in the set, averaged over the measures in the set or over a specified measure.",doc_link:"https://msdn.microsoft.com/en-us/library/ms146067.aspx"},
{name:"Ancestor",example:"Ancestor(Member_Expression, Distance)",description:"A function that returns the ancestor of a specified member at a specified level or at a specified distance from the member.",doc_link:"https://msdn.microsoft.com/en-us/library/ms145616.aspx"},{name:"ClosingPeriod",example:"ClosingPeriod( [ Level_Expression [ ,Member_Expression ] ] )",description:"Returns the member that is the last sibling among the descendants of a specified member at a specified level.",doc_link:"https://msdn.microsoft.com/en-us/library/ms145584.aspx"},
{name:"Cousin",example:"Cousin( Member_Expression , Ancestor_Member_Expression )",description:"Returns the child member with the same relative position under a parent member as the specified child member.",doc_link:"https://msdn.microsoft.com/en-us/library/ms145481.aspx"},{name:"CurrentMember",example:"Hierarchy_Expression.CurrentMember",description:"Returns the current member along a specified hierarchy during iteration.",doc_link:"https://msdn.microsoft.com/en-us/library/ms144948.aspx"},{name:"FirstChild",
example:"Member_Expression.FirstChild",description:"Returns the first child of a specified member.",doc_link:"https://msdn.microsoft.com/en-us/library/ms144947.aspx"},{name:"FirstSibling",example:"Member_Expression.FirstSibling",description:"Returns the first child of the parent of a member.",doc_link:"https://msdn.microsoft.com/en-us/library/ms145956.aspx"},{name:"IIf",example:"IIf(Logical_Expression, Expression1, Expression2)",description:"Evaluates different branch expressions depending on whether a Boolean condition is true or false.",
...
if(Settings.ALLOW_PARAMETERS){var c=function(){var b=a.editor.getValue(),c=[];if(b)for(var f=0,g=b.length;f<g-1;f++)if("$"===b[f]&&"{"===b[f+1]){for(var h="",k=!1,f=f+2;f<g;f++)if("}"!==b[f])h+=b[f];else{k=!0;f++;break}k&&h&&0<h.length&&c.push(h)}var m=a.workspace.query.helper.model().parameters,l={};_.each(c,function(a){l[a]=m[a]?m[a]:""});a.workspace.query.helper.model().parameters=l;a.workspace.update_parameters()},b=function(){_.delay(c,1E3)};a.editor&&(a.editor.getSession().off("change",b),a.editor.getSession().on("change",
...
var c=b.item.find(".level").attr("hierarchy"),d=-1;b.item.parents("ul.connectable").find("li.selection").each(function(a,b){$(b).find("ul.hierarchy").attr("hierarchy")==c&&(d=a)});var e=b.item.parents(".axis_fields").parent().attr("title"),f=$(a.target).parents(".axis_fields").parent().attr("title"),g=b.item.hasClass("d_level"),h=b.item.hasClass("dimension-level-calcmember"),k,m;h?(m=b.item.find("a.level").attr("uniquename"),this.workspace.toolbar.$el.find(".group_parents").removeClass("on"),this.workspace.toolbar.group_parents(),
this.workspace.query.helper.includeLevelCalculatedMember(e,c,k,m,d)):g?(k=b.item.find("a.level").attr("level"),this.workspace.query.helper.includeLevel(e,c,k,d)):this.workspace.query.helper.moveHierarchy(f,e,c,d);$(b.item).detach();this.workspace.sync_query();this.workspace.query.run();Saiku.events.trigger("workspaceDropZone:select_dimension",this,{level:k,uniquename:m,toAxis:e,isNew:g,isCalc:h,hierarchy:c})}},find_type_time:function(a,b,c){void 0===this.workspace.metadata&&(this.workspace.metadata=
Saiku.session.sessionworkspace.cube[this.workspace.selected_cube]);var d={};d.dimensions=_.findWhere(this.workspace.metadata.attributes.data.dimensions,{name:a});void 0===b&&(b=a);d.hierarchies=_.findWhere(d.dimensions.hierarchies,{name:b});if(void 0===d.hierarchies||null===d.hierarchies)d.hierarchies=_.findWhere(d.dimensions.hierarchies,{name:a+"."+b});d.level=_.findWhere(d.hierarchies.levels,{name:c});if(null===d.level||void 0===d.level)d.level=_.findWhere(d.hierarchies.levels,{caption:c});return d},
selections:function(a,b){a&&a.preventDefault();var c=$(a.target).hasClass("d_level")?$(a.target).find(".level"):$(a.target),d=c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[0],e=c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]?c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]:c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[0],f=c.attr("level"),g=this.find_type_time(d,e,f),h=c.attr("hierarchy"),k=c.attr("href").replace("#","");this.member=new Member({},{cube:this.workspace.selected_cube,
dimension:k});var m=decodeURIComponent(this.member.hierarchy),m=this.workspace.query.helper.getHierarchy(m),l;m&&m.levels.hasOwnProperty(f)&&(l=m.levels[f]);g.level&&void 0!==g.level.annotations&&null!==g.level.annotations&&(void 0!==g.level.annotations.AnalyzerDateFormat||void 0!==g.level.annotations.SaikuDayFormatString)&&(_.has(l,"selection")&&0===l.selection.members.length||1===_.size(l)&&_.has(l,"name")||_.has(l,"mdx")&&l.mdx||2===_.size(l)&&_.has(l,"name")&&_.has(l,"mdx"))?(new DateFilterModal({dimension:d,
hierarchy:e,target:c,name:c.attr("level"),data:g,analyzerDateFormat:g.level.annotations.AnalyzerDateFormat,dimHier:h,key:k,workspace:this.workspace})).open():(new SelectionsModal({target:c,name:c.text(),key:k,workspace:this.workspace})).open();return!1},measure_action:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;a=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent();var c={HEADER:{name:"Position",
disabled:!0,i18n:!0},sep1:"---------",BOTTOM_COLUMNS:{name:"Columns | Measures",i18n:!0},TOP_COLUMNS:{name:"Measures | Columns",i18n:!0},BOTTOM_ROWS:{name:"Rows | Measures",i18n:!0},TOP_ROWS:{name:"Measures | Rows",i18n:!0},sep2:"---------",reset:{name:"Reset Default",i18n:!0},cancel:{name:"Cancel",i18n:!0}};$.each(c,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});$.contextMenu("destroy",".limit");$.contextMenu({appendTo:a,selector:".limit",ignoreRightClick:!0,build:function(a,e){var f=
b.workspace.query;return{callback:function(a,b){var c=f.helper.model().queryModel.details;if("cancel"!==a){if("reset"===a)c.location=SaikuOlapQueryTemplate.queryModel.details.location,c.axis=SaikuOlapQueryTemplate.queryModel.details.axis;else{var d=a.split("_")[0],e=a.split("_")[1];c.location=d;c.axis=e}f.run()}},items:c}}});a.contextMenu()},limit_axis:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;
var c=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent(),d=c.siblings(".fields_list_body").parent().attr("title");$.contextMenu("destroy",".limit");$.contextMenu({appendTo:c,selector:".limit",ignoreRightClick:!0,build:function(a,f){var g={},h=Saiku.session.sessionworkspace.cube[b.workspace.selected_cube].get("data").measures,k=b.workspace.query.helper.getAxis(d),m,l,s,q,x,t,v,z,y,A=!1,r=!1,D=!1,B=!1;k&&k.filters&&_.each(k.filters,function(a){"N"==a.flavour&&(m=k["function"],l=a.expressions[0],
s=a.expressions[1],D=!0);"Generic"==a.flavour&&(q=a.expressions[0],A=!0);if("NameLike"==a.flavour||"Name"==a.flavour)q=a.expressions[0],B=!0});k&&k.sortOrder&&(x=k.sortOrder,t=k.sortEvaluationLiteral,r=!0);k&&k.aggregators&&0<k.aggregators.length&&(y=k.aggregators[0]);null!==m&&null===s?z=m+"###SEPARATOR###"+l:null!==m&&null!==s&&null!==l&&(z="custom");r&&null!==x&&(v="customsort");_.each(h,function(a){g[a.uniqueName]={name:a.caption,payload:{n:10,sortliteral:a.uniqueName}}});_.each(k.hierarchies,
function(a){for(var b in a.levels)console.log(b)});var p=function(a,b){var c={},d;for(d in a)c[b+"###SEPARATOR###"+d]=_.clone(a[d]),c[b+"###SEPARATOR###"+d].fun=b,b==m&&s==d&&a[d].payload.n==l&&(z=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e"),b==x&&t==d&&(v=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e");return c},p={filter:{name:"Filter",i18n:!0,items:{customfilter:{name:"Custom...",i18n:!0},stringfilter:{name:"String Filter",i18n:!0},clearfilter:{name:"Clear Filter",
i18n:!0}}},limit:{name:"Limit",i18n:!0,items:{"TopCount###SEPARATOR###10":{name:"Top 10",i18n:!0},"BottomCount###SEPARATOR###10":{name:"Bottom 10",i18n:!0},TopCountQuick:{name:"Top 10 by...",i18n:!0,items:p(g,"TopCount")},BottomCountQuick:{name:"Bottom 10 by...",i18n:!0,items:p(g,"BottomCount")},customtop:{name:"Custom Limit...",i18n:!0},clearlimit:{name:"Clear Limit",i18n:!0}}},sort:{name:"Sort",i18n:!0,items:{ASCQuick:{name:"Ascending",i18n:!0,items:p(g,"ASC")},DESCQuick:{name:"Descending",i18n:!0,
items:p(g,"DESC")},BASCQuick:{name:"Ascending (Breaking Hierarchy)",i18n:!0,items:p(g,"BASC")},BDESCQuick:{name:"Descending (Breaking Hierarchy)",i18n:!0,items:p(g,"BDESC")},customsort:{name:"Custom...",i18n:!0},clearsort:{name:"Clear Sort",i18n:!0}}},grand_totals:{name:"Grand totals",i18n:!0,items:{show_totals_not:{name:"None",i18n:!0},show_totals_sum:{name:"Sum",i18n:!0},show_totals_min:{name:"Min",i18n:!0},show_totals_max:{name:"Max",i18n:!0},show_totals_avg:{name:"Avg",i18n:!0}}},cancel:{name:"Cancel",
i18n:!0}};$.each(p,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});var G=p.grand_totals.items;if(y)for(var H in G)H.substring(12)==y&&(G[H].name="\x3cb\x3e"+G[H].name+"\x3c/b");else G.show_totals_not.name="\x3cb\x3e"+G.show_totals_not.name+"\x3c/b";g["10"]={payload:{n:10}};A&&(y=p.filter,y.name="\x3cb\x3e"+y.name+"\x3c/b\x3e",y.items.customfilter.name="\x3cb\x3e"+y.items.customfilter.name+"\x3c/b\x3e");B&&(y=p.filter,y.name="\x3cb\x3e"+y.name+"\x3c/b\x3e",y.items.stringfilter.name=
"\x3cb\x3e"+y.items.stringfilter.name+"\x3c/b\x3e");r&&(r=p.sort.items,p.sort.name="\x3cb\x3e"+p.sort.name+"\x3c/b\x3e",v in r&&(r[v].name="\x3cb\x3e"+r[v].name+"\x3c/b\x3e"));D&&(r=p.limit.items,p.limit.name="\x3cb\x3e"+p.limit.name+"\x3c/b\x3e",z in r&&(r[z].name="\x3cb\x3e"+r[z].name+"\x3c/b\x3e"));return{callback:function(a,e){var f;if("cancel"!=a)if("clearfilter"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,"Generic"),b.synchronize_query(),b.workspace.query.run();else if("customfilter"==
a)f=function(a){var c=[];c.push(a);b.workspace.query.helper.removeFilter(k,"Generic");k.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:q,expressionType:"Filter",workspace:b.workspace})).render().open();else if("stringfilter"==a)f=function(a,c,d){var e=[];_.each(d,function(b){e.push(a,b)});"EQUALS"===c||"NOTEQUAL"===c?(d=null,"NOTEQUAL"===c&&(d="NOTEQUAL"),
k.filters.push({flavour:"Name",operator:d,"function":"Filter",expressions:e})):(d=null,"NOTLIKE"===c&&(d="NOTEQUAL"),k.filters.push({flavour:"NameLike",operator:d,"function":"Filter",expressions:e}));b.synchronize_query()},(new StringFilterModal({axis:d,success:f,query:b.workspace.query,expression:q,expressionType:"Filter",workspace:b.workspace})).render().open();else if("clearlimit"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,"N"),b.synchronize_query(),b.workspace.query.run();
else if("customtop"==a)f=function(a,c,d){var e=[];e.push(c);d&&e.push(d);b.workspace.query.helper.removeFilter(k,"N");k.filters.push({flavour:"N",operator:null,"function":a,expressions:e});b.synchronize_query();b.workspace.query.run()},(new CustomFilterModal({axis:d,measures:h,success:f,query:b.workspace.query,func:m,n:l,sortliteral:s})).render().open();else if("customsort"==a)f=function(a,c){k.sortOrder=a;k.sortEvaluationLiteral=c;b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,
success:f,query:b.workspace.query,expression:t,expressionType:"Order"})).render().open();else{if("clearsort"==a)k.sortOrder=null,k.sortEvaluationLiteral=null,b.synchronize_query();else if(0===a.indexOf("show_totals_")){f=a.substring(12);var r=[];r.push(f);k.aggregators=r}else{f=a.split("###SEPARATOR###")[0];var n=a.split("###SEPARATOR###")[1];-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f)?(k.sortOrder=f,k.sortEvaluationLiteral=g[n].payload.sortliteral):-1<_.indexOf(["Param"],f)?(console.log("here"),
k.sortEvaluationLiteral=g[n].payload.sortliteral):(r=[],r.push(g[n].payload.n),(n=g[n].payload.sortliteral)&&r.push(n),b.workspace.query.helper.removeFilter(k,"N"),k.filters.push({flavour:"N",operator:null,"function":f,expressions:r}));b.synchronize_query()}b.workspace.query.run()}},items:p}}});c.contextMenu()}}),Table=Backbone.View.extend({className:"table_wrapper",events:{"click th.row":"clicked_cell","click th.col":"clicked_cell"},initialize:function(a){this.workspace=a.workspace;this.renderer=
new SaikuTableRenderer;_.bindAll(this,"render","process_data");this.workspace.bind("query:result",this.render);this.id=_.uniqueId("table_");$(this.el).attr("id",this.id)},clicked_cell:function(a){var b=this;0<$(this.workspace.el).find(".workspace_results.ui-selectable").length&&$(this.workspace.el).find(".workspace_results").selectable("destroy");a=$(a.target).hasClass("row")||$(a.target).hasClass("col")?$(a.target).find("div"):$(a.target);$(document);$.contextMenu("destroy",".row, .col");$.contextMenu({appendTo:a,
selector:".row, .col",ignoreRightClick:!0,build:function(a,d){var e=$(d.currentTarget).find("div"),f=$(d.currentTarget).hasClass("row")?"ROWS":"COLUMNS",g=e.attr("rel").split(":"),h=parseInt(g[0]),g=parseInt(g[1]),k=b.workspace.query.result.lastresult().cellset[h][g],h=b.workspace.query;h.get("schema");h.get("connection");h.get("catalog");h.get("cube");var m=k.properties.dimension,l=k.properties.hierarchy,s=k.properties.level,q="",x=JSON.stringify({hierarchy:l,uniquename:s,type:"level",action:"delete"})+
","+JSON.stringify({hierarchy:l,uniquename:k.properties.uniquename,type:"member",action:"add"}),h=k.properties.uniquename,t={},g=b.workspace.selected_cube,v;Saiku.session.sessionworkspace.cube[g]&&v&&measures||("undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+g)?Saiku.session.sessionworkspace.cube[g]=new Cube(JSON.parse(localStorage.getItem("cube."+g))):(Saiku.session.sessionworkspace.cube[g]=new Cube({key:g}),Saiku.session.sessionworkspace.cube[g].fetch({async:!1})),
v=Saiku.session.sessionworkspace.cube[g].get("data").dimensions);var z=[],g=b.workspace.query.helper.getHierarchy(l);_.each(g.levels,function(a){z.push(l+".["+a.name+"]")});_.each(v,function(a){a.name==m&&_.each(a.hierarchies,function(a){a.uniqueName==l&&_.each(a.levels,function(a){t[a.name]={name:a.caption,payload:JSON.stringify({hierarchy:l,uniquename:a.uniqueName,type:"level",action:"add"})};-1<_.indexOf(z,a.uniqueName)&&(t[a.name].disabled=!0,t["remove-"+a.name]={name:a.caption,payload:JSON.stringify({hierarchy:l,
uniquename:a.uniqueName,type:"level",action:"delete"})});a.uniqueName==s&&(q=a.caption,l_name=a.name);t["keep-"+a.name]=t[a.name];t["include-"+a.name]=JSON.parse(JSON.stringify(t[a.name]));t["keep-"+a.name].payload=x+","+t[a.name].payload})})});t.keeponly={payload:x};t.getchildren={payload:h};t.hasOwnProperty("remove-"+l_name)&&t.hasOwnProperty("include-"+l_name)&&(t.showall={payload:t["remove-"+l_name].payload+", "+t["include-"+l_name].payload});v=function(a){var b={},c;for(c in t)null!==a&&a.length<
c.length&&c.substr(0,a.length)==a&&(b[c]=t[c]);return b};h={name:{name:"\x3cb\x3e"+e.html()+"\x3c/b\x3e",disabled:!0},sep1:"---------",keeponly:{name:"Keep Only",i18n:!0,payload:x}};"Measures"!=m&&(h.fold1key={name:"Include Level",i18n:!0,items:v("include-")},h.fold2key={name:"Keep and Include Level",i18n:!0,items:v("keep-")},h.fold3key={name:"Remove Level",i18n:!0,items:v("remove-")},h.filterlevel={name:"Filter Level",i18n:!0});$.each(h,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});
return{callback:function(a,c){var d=[];if("keeponly"===a){var g=b.workspace.query.helper.getHierarchy(l);g&&g.levels.hasOwnProperty(q)&&(d.push({uniqueName:k.properties.uniquename,caption:k.properties.uniquename}),g.levels[q].selection={type:"INCLUSION",members:d},b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))}else if("filterlevel"===a)d=k.properties.level.substring(k.properties.level.lastIndexOf(".")+1),d=d.replace("[","").replace("]",""),(new SelectionsModal({target:e,name:"Filter Level",
key:k.properties.hierarchy+"/"+d,workspace:b.workspace,axis:"ROWS"})).open();else if("remove"===a.substring(0,a.indexOf("-"))){var h=a.substring(a.indexOf("-")+1);b.workspace.query.helper.removeLevel(l,h);b.workspace.drop_zones.synchronize_query();b.workspace.query.run(!0)}else"keep"===a.substring(0,a.indexOf("-"))?(h=a.substring(a.indexOf("-")+1),(g=b.workspace.query.helper.getHierarchy(l))&&g.levels.hasOwnProperty(q)&&(d.push({uniqueName:k.properties.uniquename,caption:k.properties.uniquename}),
g.levels[q].selection={type:"INCLUSION",members:d},b.workspace.query.helper.includeLevel(f,l,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))):"include"===a.substring(0,a.indexOf("-"))&&(h=a.substring(a.indexOf("-")+1),b.workspace.query.helper.includeLevel(f,l,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))},items:h}}});a.contextMenu()},render:function(a,b){"undefined"==typeof a||"undefined"==typeof a.data||$(this.workspace.el).is(":visible")&&
!$(this.el).is(":visible")||null!==a.data&&null!==a.data.error||null===a.data||a.data.height&&0===a.data.height||(this.clearOut(),$(this.el).html("Rendering "+a.data.width+" columns and "+a.data.height+" rows..."),_.delay(this.process_data,2,a.data))},clearOut:function(){this.renderer.clear();$(this.workspace.el).find(".workspace_results").unbind("scroll");var a=document.getElementById(this.id),b=a.firstChild;b&&a.removeChild(b)},template_filter:function(a){return _.template('\x3cdiv class\x3d"table-applied-filter"\x3e\x3cp\x3eApplied filters:\x3c/p\x3e\x3ctable\x3e\x3c% _.each(obj, function(value) { %\x3e\x3ctr\x3e\x3ctd\x3e\x3c%\x3d value.hName %\x3e \x3cspan style\x3d"float: right"\x3e\x26#187;\x3c/span\x3e\x3c/td\x3e\x3c% if (value.members \x26\x26 !(_.isEmpty(value.members))) { %\x3e\x3ctd\x3e\x3c%\x3d value.lName %\x3e \x3cspan style\x3d"float: right"\x3e\x26#187;\x3c/span\x3e\x3c/td\x3e\x3ctd\x3e\x3c%\x3d value.members[0] %\x3e\x3c/td\x3e\x3c% } else { %\x3e\x3ctd\x3e\x3c%\x3d value.lName %\x3e\x3c/td\x3e\x3c% } %\x3e\x3c/tr\x3e\x3c% if (value.members \x26\x26 value.members.length \x3e 1) { %\x3e\x3c% _.each(_.rest(value.members), function(value, key, list) { %\x3e\x3ctr\x3e\x3ctd colspan\x3d"2"\x3e\x3cspan style\x3d"float: right"\x3e\x26#187;\x3c/span\x3e\x3c/td\x3e\x3ctd\x3e\x3c%\x3d list[key] %\x3e\x3c/td\x3e\x3c/tr\x3e\x3c% }); %\x3e\x3c% } %\x3e\x3c% }); %\x3e\x3c/table\x3e\x3c/div\x3e')(a)},
process_filter:function(){var a=this.workspace.query.helper.getAxis("FILTER"),b=[];null!=a&&a.hierarchies&&!_.isEmpty(a.hierarchies)?_.each(a.hierarchies,function(a){_.each(a.levels,function(d){b.push({hName:a.caption,lName:d.name});_.find(b,function(a){a.lName===d.name&&(a.members=[],_.each(d.selection.members,function(b){a.members.push(b.name)}))})})}):b=null;return b},process_data:function(a){var b=this.process_filter(),b=b?this.template_filter(b):"";this.workspace.processing.hide();this.workspace.adjust();
this.clearOut();$(this.el).html('\x3ctable id\x3d"'+this.id+'"\x3e\x3c/table\x3e').append(b);this.renderer.render(a,{htmlObject:$(this.el).find("#"+this.id),batch:Settings.TABLE_LAZY,batchSize:Settings.TABLE_LAZY_SIZE,batchIntervalSize:Settings.TABLE_LAZY_LOAD_ITEMS,batchIntervalTime:Settings.TABLE_LAZY_LOAD_TIME});this.post_process()},post_process:function(){"QM"==this.workspace.query.get("type")&&"view"!=Settings.MODE?$(this.el).addClass("headerhighlight"):$(this.el).removeClass("headerhighlight");
$(this.el).find(".i18n").i18n(Saiku.i18n.po_file);this.workspace.trigger("table:rendered",this);this.workspace.trigger("report:rendered",this)}}),Workspace=Backbone.View.extend({className:"tab_container",events:{"click .sidebar_separator":"toggle_sidebar","change .cubes":"new_query","drop .sidebar":"remove_dimension","drop .workspace_results":"remove_dimension","click .refresh_cubes":"refresh","click .cancel":"cancel","click .admin":"admin"},initialize:function(a){_.bindAll(this,"caption","adjust",
"toggle_sidebar","prepare","new_query","set_class_charteditor","init_query","update_caption","populate_selections","refresh","sync_query","cancel","cancelled","no_results","error","switch_view_state");_.extend(this,Backbone.Events);this.loaded=!1;this.bind("query:result",this.render_result);this.toolbar=new WorkspaceToolbar({workspace:this});this.toolbar.render();this.upgrade=new Upgrade({workspace:this});this.upgrade.render();this.querytoolbar=new QueryToolbar({workspace:this});this.querytoolbar.render();
this.drop_zones=new WorkspaceDropZone({workspace:this});this.drop_zones.render();this.table=new Table({workspace:this});this.chart=new Chart({workspace:this});this.dateFilter=new DateFilterCollection;this.item={};this.viewState=a&&a.viewState?a.viewState:Settings.DEFAULT_VIEW_STATE;this.isReadOnly="view"==Settings.MODE||!1;a&&a.item&&(this.item=a.item)&&this.item.hasOwnProperty("acl")&&0>_.indexOf(this.item.acl,"WRITE")&&(this.isReadOnly=!0,this.viewState="view");a&&(a.query||a.viewState)||(this.viewState=
"edit");a&&a.query&&(this.query=a.query,this.query.workspace=this,this.query.save({},{success:this.init_query,error:function(){Saiku.ui.unblock();if(1>$("body").find(".error_loading_query").length){var a=Saiku.i18n&&Saiku.i18n.po_file.error_loading_query?Saiku.i18n.po_file.error_loading_query:null;a||($('\x3cspan class\x3d"i18n error_loading_query"\x3eError Loading Query\x3c/span\x3e').hide().appendTo("body"),Saiku.i18n.translate(),a=$(".error_loading_query").text())}else a=$(".error_loading_query").text();
alert(a)}}));Saiku.session.bind("tab:add",this.prepare);var b=Saiku.URLParams.paramsURI();void 0!=a&&void 0!=a.processURI&&0==a.processURI&&(b={});Saiku.URLParams.equals({schema:b.schema,cube:b.cube});this.data_connections(b)},afterRender:function(){console.log("After render")},caption:function(a){if(this.query&&this.query.model){if(this.item&&this.item.name)return this.item.name.split(".")[0];if(this.query.model.mdx)return this.query.model.name}else if(this.query&&this.query.get("name"))return this.query.get("name");
a&&Saiku.tabs.queryCount++;return"\x3cspan class\x3d'i18n'\x3eUnsaved query\x3c/span\x3e ("+Saiku.tabs.queryCount+")"},selected_cube_template:function(a){var b=Saiku.session.sessionworkspace;b.selected=a;return _.template('\x3cselect class\x3d"cubes"\x3e\x3coption value\x3d"" class\x3d"i18n"\x3eSelect a cube\x3c/option\x3e\x3c% _.each(connections, function(connection) { %\x3e\x3c% _.each(connection.catalogs, function(catalog) { %\x3e\x3c% _.each(catalog.schemas, function(schema) { %\x3e\x3c% if (schema.cubes.length \x3e 0) { %\x3e\x3coptgroup label\x3d"\x3c%\x3d (schema.name !\x3d\x3d "" ? schema.name : catalog.name) %\x3e \x3c%\x3d (connection.name) %\x3e"\x3e\x3c% _.each(schema.cubes, function(cube) { %\x3e\x3c% if ((typeof cube["visible"] \x3d\x3d\x3d "undefined" || cube["visible"]) \x26\x26 selected !\x3d\x3d cube.caption) { %\x3e\x3coption value\x3d"\x3c%\x3d connection.name %\x3e/\x3c%\x3d catalog.name %\x3e/\x3c%\x3d ((schema.name \x3d\x3d\x3d "" || schema.name \x3d\x3d\x3d null) ? "null" : schema.name) %\x3e/\x3c%\x3d encodeURIComponent(cube.name) %\x3e"\x3e\x3c%\x3d ((cube.caption \x3d\x3d\x3d "" || cube.caption \x3d\x3d\x3d null) ? cube.name : cube.caption) %\x3e\x3c/option\x3e\x3c% } else if ((typeof cube["visible"] \x3d\x3d\x3d "undefined" || cube["visible"]) \x26\x26 selected \x3d\x3d\x3d cube.caption) { %\x3e\x3coption value\x3d"\x3c%\x3d connection.name %\x3e/\x3c%\x3d catalog.name %\x3e/\x3c%\x3d ((schema.name \x3d\x3d\x3d "" || schema.name \x3d\x3d\x3d null) ? "null" : schema.name) %\x3e/\x3c%\x3d encodeURIComponent(cube.name) %\x3e" selected\x3e\x3c%\x3d ((cube.caption \x3d\x3d\x3d "" || cube.caption \x3d\x3d\x3d null) ? cube.name : cube.caption) %\x3e\x3c/option\x3e\x3c% } %\x3e\x3c% }); %\x3e\x3c/optgroup\x3e\x3c% } %\x3e\x3c% }); %\x3e\x3c% }); %\x3e\x3c% }); %\x3e\x3c/select\x3e')(b)},
...
$(k).attr("selection-name")&&(e=$("#period-select").find(":selected").val(),c="lastperiods",f=$(k).find("input:text").val(),h.fixedDateName=c,h.periodAmount=$(k).find("input:text").val(),h.periodSelect=$("#period-select").find(":selected").attr("id"));var m=b.dataLevels.length,x,t;for(t=0;t<m;t++)b.dataLevels[t].analyzerDateFormat===e&&(x=b.dataLevels[t].name);m={dimension:b.dimension,hierarchy:b.hierarchy,level:b.name,analyzerDateFormat:e,periodAmount:f,comparisonOperator:d,workinglevel:x};g="dayperiods"===
c&&""!==b.selectedDates[0]&&void 0!==b.selectedDates[0]||"lastperiods"===c&&!_.isEmpty(e)&&"Day(s)"!==e&&!_.isEmpty(f)||"dayperiods"!==c&&"lastperiods"!==c&&!_.isEmpty(e)?b.populate_mdx(m,c):null}});var k=decodeURIComponent(this.member.hierarchy);a=decodeURIComponent(this.member.level);k=this.workspace.query.helper.getHierarchy(k);this.get_cube_name();_.extend(h,this.levelInfo);if("dayperiods"===c&&""!==this.selectedDates[0]&&void 0!==b.selectedDates[0]||"lastperiods"===c&&!_.isEmpty(e)&&"Day(s)"!==
e&&!_.isEmpty(f)||"dayperiods"!==c&&"lastperiods"!==c&&!_.isEmpty(e))this.set_date_filter(h);else{var m=this.get_uuid(h);this.workspace.dateFilter.remove(m);this.workspace.query.setProperty("saiku.ui.datefilter.data",this.workspace.dateFilter.toJSON())}k&&k.levels.hasOwnProperty(a)&&(k.levels[a]={mdx:g,name:a});this.finished()},get_cube_name:function(){return decodeURIComponent(this.workspace.selected_cube.split("/")[3])},get_uuid:function(a){return"["+a.cube+"]."+this.dimHier+".["+a.name+"]"},set_date_filter:function(a){var b=
...
(function(a){var b;a:{try{document.createElement("$")}catch(c){b=c;break a}b=void 0}a.Base64||(a.Base64={encode:function(a){for(var c,f,g,h,k,m,l=0,s=a.length,q=Math.max,x="";l<s;){c=a.charCodeAt(l++)||0;f=a.charCodeAt(l++)||0;m=a.charCodeAt(l++)||0;if(255<q(c,f,m))throw b;g=c>>2&63;c=(c&3)<<4|f>>4&15;h=(f&15)<<2|m>>6&3;k=m&63;f?m||(k=64):h=k=64;x+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(g)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(k)}return x}})})(this);
...
var ChartEditor=Modal.extend({type:"chart-editor",message:'\x3cform class\x3d"form-group-inline"\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"chart-title" class\x3d"i18n"\x3eChart Title:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"chart-title"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"xtitle" class\x3d"i18n"\x3eX Axis label:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"xtitle"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"ytitle" class\x3d"i18n"\x3eY Axis label:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"ytitle"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"colors" class\x3d"i18n"\x3eColours:\x3c/label\x3e\x3cinput type\x3d"color" id\x3d"color1"\x3e\x3cinput type\x3d"color" class\x3d"startEmpty" id\x3d"color2"\x3e\x3cinput type\x3d"color" class\x3d"startEmpty" id\x3d"color3"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group "\x3e\x3clabel for\x3d"legend" class\x3d"i18n"\x3eShow Legend:\x3c/label\x3e\x3clabel for\x3d"legend" class\x3d"lbl-legend-yes i18n"\x3e\x3cinput type\x3d"radio" name\x3d"legend" value\x3d"true" checked\x3e Yes\x3c/label\x3e\x3clabel for\x3d"legend" class\x3d"lbl-legend-no i18n"\x3e\x3cinput type\x3d"radio" name\x3d"legend" value\x3d"false"\x3e No\x3c/label\x3e\x3c/div\x3e\x3cdiv class\x3d"div-trend"\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"trend-line" class\x3d"i18n"\x3eTrend Line:\x3c/label\x3e\x3cselect class\x3d"form-control" id\x3d"trend-line"\x3e\x3coption value\x3d"none" class\x3d"i18n"\x3eNone\x3c/option\x3e\x3coption value\x3d"linear" class\x3d"i18n"\x3eLinear\x3c/option\x3e\x3coption value\x3d"weighted-moving-average" class\x3d"i18n"\x3eWeighted Moving Average\x3c/option\x3e\x3coption value\x3d"moving-average" class\x3d"i18n"\x3eMoving Average\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3cdiv class\x3d"div-trend-points"\x3e\x3clabel for\x3d"trend-points" class\x3d"i18n"\x3eTrend Periods:\x3c/label\x3e\x3cinput class\x3d"form-control" type\x3d"text" id\x3d"trend-points" value\x3d"3"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3c/form\x3e',buttons:[{text:"Save",
method:"save"},{text:"Cancel",method:"close"}],events:{"click  .dialog_footer a":"call","change #trend-line":"hide_periods"},initialize:function(a){_.extend(this,a);this.options.title="Chart Settings";this.renderer={};a&&a.workspace&&a.data&&(this.workspace=a.workspace,this.renderer=a.data);_.bindAll(this,"template_editor","get_chart_properties","hide_periods");this.bind("open",function(){this.get_chart_properties()})},template_editor:function(){return this.message},spectrum_options:function(a){return{color:a,
showInput:!0,showInitial:!0,showPalette:!0,showSelectionPalette:!0,maxPaletteSize:10,preferredFormat:"hex",palette:["rgb(0, 0, 0);rgb(67, 67, 67);rgb(102, 102, 102);rgb(153, 153, 153);rgb(183, 183, 183);rgb(204, 204, 204);rgb(217, 217, 217);rgb(239, 239, 239);rgb(243, 243, 243);rgb(255, 255, 255)".split(";"),"rgb(152, 0, 0);rgb(255, 0, 0);rgb(255, 153, 0);rgb(255, 255, 0);rgb(0, 255, 0);rgb(0, 255, 255);rgb(74, 134, 232);rgb(0, 0, 255);rgb(153, 0, 255);rgb(255, 0, 255)".split(";"),"rgb(230, 184, 175);rgb(244, 204, 204);rgb(252, 229, 205);rgb(255, 242, 204);rgb(217, 234, 211);rgb(208, 224, 227);rgb(201, 218, 248);rgb(207, 226, 243);rgb(217, 210, 233);rgb(234, 209, 220);rgb(234, 153, 153);rgb(249, 203, 156);rgb(255, 229, 153);rgb(182, 215, 168);rgb(162, 196, 201);rgb(164, 194, 244);rgb(159, 197, 232);rgb(180, 167, 214);rgb(213, 166, 189);rgb(204, 65, 37);rgb(246, 178, 107);rgb(255, 217, 102);rgb(147, 196, 125);rgb(118, 165, 175);rgb(109, 158, 235);rgb(111, 168, 220);rgb(142, 124, 195);rgb(194, 123, 160);rgb(166, 28, 0);rgb(204, 0, 0);rgb(241, 194, 50);rgb(106, 168, 79);rgb(69, 129, 142);rgb(60, 120, 216);rgb(61, 133, 198);rgb(103, 78, 167);rgb(166, 77, 121);rgb(133, 32, 12);rgb(153, 0, 0);rgb(180, 95, 6);rgb(56, 118, 29);rgb(19, 79, 92);rgb(17, 85, 204);rgb(11, 83, 148);rgb(53, 28, 117);rgb(116, 27, 71);rgb(91, 15, 0);rgb(102, 0, 0);rgb(120, 63, 4);rgb(127, 96, 0);rgb(12, 52, 61);rgb(28, 69, 135);rgb(7, 55, 99);rgb(32, 18, 77);rgb(76, 17, 48)".split(";")]}},
get_chart_properties:function(){var a=Array.prototype.slice.call(arguments),b={};_.isEmpty(a)?b=this.workspace.query.getProperty("saiku.ui.chart.options"):(this.$el=a[0].element,this.renderer.type=a[0].type,a[0].chartDefinition&&!_.isEmpty(a[0].chartDefinition)&&(b.chartDefinition=_.isString(a[0].chartDefinition)?JSON.parse(a[0].chartDefinition):a[0].chartDefinition));void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.title&&this.$el.find("#chart-title").val(b.chartDefinition.title);
void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.baseAxisTitle&&this.$el.find("#xtitle").val(b.chartDefinition.baseAxisTitle);void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.orthoAxisTitle&&this.$el.find("#ytitle").val(b.chartDefinition.orthoAxisTitle);void 0===b||void 0===b.chartDefinition||void 0===b.chartDefinition.colors?(this.$el.find("#color1").spectrum(this.spectrum_options("#bb0000")),this.$el.find("#color2").spectrum(this.spectrum_options("#007070")),this.$el.find("#color3").spectrum(this.spectrum_options("#74af00"))):
(this.$el.find("#color1").spectrum(this.spectrum_options(b.chartDefinition.colors[0])),this.$el.find("#color2").spectrum(this.spectrum_options(b.chartDefinition.colors[1])),this.$el.find("#color3").spectrum(this.spectrum_options(b.chartDefinition.colors[2])));void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.legend&&this.$el.find('input[type\x3dradio][value\x3d"'+b.chartDefinition.legend+'"]').first().attr("checked","checked");"line"===this.renderer.type?(this.$el.find(".div-trend").show(),
void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.trend?(this.$el.find("#trend-line").val(b.chartDefinition.trend.type),"linear"!==b.chartDefinition.trend.type||"none"!==b.chartDefinition.trend.type?(this.$el.find(".div-trend-points").show(),this.$el.find("#trend-points").val(b.chartDefinition.trend.periods)):this.$el.find(".div-trend-points").hide()):this.$el.find(".div-trend-points").hide()):this.$el.find(".div-trend").hide()},hide_periods:function(a){a.preventDefault();a=$(a.currentTarget).val();
"linear"!==a&&"none"!==a?this.$el.find(".div-trend-points").show():this.$el.find(".div-trend-points").hide()},save:function(a){a.preventDefault();a={};var b=[];a.chartDefinition={};this.renderer.cccOptions.title=this.$el.find("#chart-title").val();null!==this.$el.find("#chart-title").val()&&(a.chartDefinition.title=this.$el.find("#chart-title").val());null!==this.$el.find("#xtitle").val()&&(a.chartDefinition.baseAxisTitle=this.$el.find("#xtitle").val());null!==this.$el.find("#ytitle").val()&&(a.chartDefinition.orthoAxisTitle=
this.$el.find("#ytitle").val());null===this.$el.find("#color1").val()&&""===this.$el.find("#color1").val()||b.push(this.$el.find("#color1").spectrum("get").toHexString());null===this.$el.find("#color2").val()&&""===this.$el.find("#color2").val()||b.push(this.$el.find("#color2").spectrum("get").toHexString());null===this.$el.find("#color3").val()&&""===this.$el.find("#color3").val()||b.push(this.$el.find("#color3").spectrum("get").toHexString());a.chartDefinition.colors=b;a.chartDefinition.legend=
"true"===this.$el.find("input:radio[name\x3dlegend]:checked").val();"none"!==this.$el.find("#trend-line").val()?a.chartDefinition.trend={type:this.$el.find("#trend-line").val(),periods:this.$el.find("#trend-points").val()}:a.chartDefinition.trend=null;b=this.workspace.querytoolbar.$el.find("ul.chart li").not(".chart_editor").find("a.on").attr("href").replace("#","");this.workspace.querytoolbar.$el.find('ul.chart [href\x3d"#charteditor"]').addClass("on");this.renderer.switch_chart(this.renderer.type,
a);this.workspace.query.setProperty("saiku.ui.chart.options",a);this.workspace.query.setProperty("saiku.ui.render.type",b);this.$el.dialog("close")}}),MapEditor=Modal.extend({type:"map-editor",message:'\x3cform class\x3d"form-group"\x3e\x3clabel for\x3d"map-type" class\x3d"i18n"\x3eMap Type:\x3c/label\x3e\x3cselect id\x3d"map-type"\x3e\x3c/select\x3e\x3cdiv class\x3d"div-country" hidden\x3e\x3clabel for\x3d"select-country" class\x3d"i18n"\x3eSelect Country Field:\x3c/label\x3e\x3cselect id\x3d"select-country"\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"div-geo"\x3e\x3clabel for\x3d"geo-lookup" class\x3d"i18n"\x3eGeo Lookup: \x3cinput type\x3d"checkbox" id\x3d"geo-lookup" value\x3d"true" checked\x3e\x3c/label\x3e\x3cdiv class\x3d"div-latlon" hidden\x3e\x3clabel for\x3d"lat" class\x3d"i18n"\x3eLatitude Field:\x3c/label\x3e\x3cselect id\x3d"lat"\x3e\x3coption value\x3d""\x3e\x3c/option\x3e\x3c/select\x3e\x3clabel for\x3d"lon" class\x3d"i18n"\x3eLongitude Field:\x3c/label\x3e\x3cselect id\x3d"lon"\x3e\x3coption value\x3d""\x3e\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"div-metric"\x3e\x3clabel for\x3d"select-metric" class\x3d"i18n"\x3eSelect a Metric:\x3c/label\x3e\x3cselect id\x3d"select-metric"\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"div-lookup"\x3e\x3cdiv class\x3d"div-search chosen-mb" hidden\x3e\x3clabel for\x3d"street-lookups" class\x3d"i18n"\x3eStreet Mapping:\x3c/label\x3e\x3cselect id\x3d"street-lookups"\x3e\x3coption value\x3d""\x3e\x3c/option\x3e\x3c/select\x3e\x3clabel for\x3d"city-lookups" class\x3d"i18n"\x3eCity Mapping:\x3c/label\x3e\x3cselect id\x3d"city-lookups"\x3e\x3coption value\x3d""\x3e\x3c/option\x3e\x3c/select\x3e\x3clabel for\x3d"county-lookups" class\x3d"i18n"\x3eCounty Mapping:\x3c/label\x3e\x3cselect id\x3d"county-lookups"\x3e\x3coption value\x3d""\x3e\x3c/option\x3e\x3c/select\x3e\x3clabel for\x3d"state-lookups" class\x3d"i18n"\x3eState Mapping:\x3c/label\x3e\x3cselect id\x3d"state-lookups"\x3e\x3coption value\x3d""\x3e\x3c/option\x3e\x3c/select\x3e\x3clabel for\x3d"country-lookups" class\x3d"i18n"\x3eCountry Mapping:\x3c/label\x3e\x3cselect id\x3d"country-lookups"\x3e\x3coption value\x3d""\x3e\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3c/div\x3e\x3c/form\x3e',
buttons:[{text:"Save",method:"save"},{text:"Cancel",method:"close"},{text:"Help",method:"help"}],events:{"click  .dialog_footer a":"call","change #map-type":"change_map","click  #geo-lookup":"change_geo"},initialize:function(a){_.extend(this,a);this.options.title="Map Settings";if(a&&a.data&&_.has(a,"data")){var b=this.workspace.query.getProperty("saiku.ui.map.options"),c=b?b.mapDefinition.type:"";this.renderer=a.data}else this.$el=a;_.bindAll(this,"template_editor","post_render","show_map_type",
"get_rows","get_map_properties");this.bind("open",function(){this.post_render();this.show_map_type();this.get_rows(this.workspace.query);this.get_map_properties(b,c);this.$el.find("select").chosen({allow_single_deselect:!0})})},template_editor:function(){return this.message},help:function(a){a.preventDefault();window.open("http://wiki.meteorite.bi/display/SAIK/Maps")},post_render:function(){var a=($("body").height()-500)/2*100/$("body").height(),b=($("body").width()-500)/2*100/$("body").width();this.$el.dialog("option",
"position","center");this.$el.parents(".ui-dialog").css({width:"500px",top:a+"%",left:b+"%"})},show_map_type:function(){"OSM"===Settings.MAPS_TYPE&&(this.$el.find("#map-type").append('\x3coption value\x3d"map_heat"\x3eHeat Map\x3c/option\x3e\x3coption value\x3d"map_marker" selected\x3eMarker Map\x3c/option\x3e'),this.$el.find(".div-search").show())},option_template:function(a){return _.template('\x3c% _.each(obj.data, function(name) { %\x3e\x3coption value\x3d"\x3c%\x3d name %\x3e"\x3e\x3c%\x3d name %\x3e\x3c/option\x3e\x3c% }); %\x3e')({data:a})},
get_rows:function(a){var b=a.model?a.model.queryModel.details.measures:a.queryModel.details.measures,c=[],d=[];_.each(a.model?a.model.queryModel.axes.ROWS.hierarchies:a.queryModel.axes.ROWS.hierarchies,function(a){_.each(a.levels,function(a){c.push(a.name)})});_.each(b,function(a){d.push(a.name)});a=this.option_template(c);b=this.option_template(d);this.$el.find("#select-country").append(a);this.$el.find("#lookups").append(a);this.$el.find("#street-lookups").append(a);this.$el.find("#city-lookups").append(a);
this.$el.find("#county-lookups").append(a);this.$el.find("#state-lookups").append(a);this.$el.find("#country-lookups").append(a);this.$el.find("#lat").append(a);this.$el.find("#lon").append(a);this.$el.find("#select-metric").append(b)},switch_map_type:function(a){switch(a){case "map_geo":this.$el.find(".div-geo").hide();this.$el.find(".div-country").show();this.$el.find(".div-metric").show();this.$el.find(".div-latlon").removeClass("chosen-mb");break;case "map_heat":this.$el.find(".div-geo").show();
this.$el.find(".div-country").hide();this.$el.find(".div-metric").hide();this.$el.find(".div-latlon").addClass("chosen-mb");break;case "map_marker":this.$el.find(".div-geo").show(),this.$el.find(".div-country").hide(),this.$el.find(".div-metric").show(),this.$el.find(".div-latlon").removeClass("chosen-mb")}},get_map_properties:function(a,b){this.switch_map_type(b);if("map_marker"===b||"map_heat"===b){var c=a.mapDefinition.search;this.$el.find("#map-type").val(b);this.$el.find("#map-type").trigger("chosen:updated");
null!==a.mapDefinition.latfield&&void 0!==a.mapDefinition.latfield||null!==a.mapDefinition.lonfield&&void 0!==a.mapDefinition.lonfield?(this.$el.find("#geo-lookup").prop("checked",!1),this.$el.find("#lat").val(a.mapDefinition.latfield),this.$el.find("#lon").val(a.mapDefinition.lonfield),this.$el.find("#lat").trigger("chosen:updated"),this.$el.find("#lon").trigger("chosen:updated")):(this.$el.find("#geo-lookup").prop("checked",!0),this.$el.find("#lookups").val(a.mapDefinition.lookupfields),this.$el.find("#lookups").trigger("chosen:updated"),
this.$el.find("#geo-bias").val(a.mapDefinition.bias),void 0!==c.street&&""!==c.street&&this.$el.find("#street-lookups").val(c.street),void 0!==c.city&&""!==c.city&&this.$el.find("#city-lookups").val(c.city),void 0!==c.county&&""!==c.county&&this.$el.find("#county-lookups").val(c.county),void 0!==c.state&&""!==c.state&&this.$el.find("#state-lookups").val(c.state),void 0!==c.country&&""!==c.country&&this.$el.find("#country-lookups").val(c.country))}else"map_geo"===b&&(this.$el.find("#map-type").val(b),
this.$el.find("#map-type").trigger("chosen:updated"),this.$el.find("#select-country").val(a.mapDefinition.lookupfields),this.$el.find("#select-country").trigger("chosen:updated"));if("map_marker"===b||"map_geo"===b)this.$el.find("#select-metric").val(a.mapDefinition.metric),this.$el.find("#select-metric").trigger("chosen:updated");a&&a.mapDefinition&&null!==a.mapDefinition.search&&void 0!==a.mapDefinition.search&&(this.$el.find("#street-lookups").val(c.street),this.$el.find("#city-lookups").val(c.city),
this.$el.find("#county-lookups").val(c.county),this.$el.find("#state-lookups").val(c.state),this.$el.find("#country-lookups").val(c.country),this.$el.find("#street-lookups").trigger("chosen:updated"),this.$el.find("#city-lookups").trigger("chosen:updated"),this.$el.find("#county-lookups").trigger("chosen:updated"),this.$el.find("#state-lookups").trigger("chosen:updated"),this.$el.find("#country-lookups").trigger("chosen:updated"));this.change_geo()},change_map:function(a){a.preventDefault();a=$(a.currentTarget).val();
this.switch_map_type(a)},change_geo:function(){this.$el.find("#geo-lookup").is(":checked")?(this.$el.find(".div-lookup").show(),this.$el.find(".div-latlon").hide(),this.$el.find(".div-metric").removeClass("chosen-mb")):(this.$el.find(".div-lookup").hide(),this.$el.find(".div-latlon").show(),this.$el.find(".div-metric").addClass("chosen-mb"))},save:function(a){a.preventDefault();a=this.$el.find("#map-type").val();var b={},c;b.mapDefinition={};b.mapDefinition.type=a;"map_geo"===a?b.mapDefinition.lookupfields=
this.$el.find("#select-country").val():this.$el.find("#geo-lookup").is(":checked")?(b.mapDefinition.lookupfields=this.$el.find("#lookups").val(),b.mapDefinition.latfield=null,b.mapDefinition.lonfield=null,b.mapDefinition.bias=this.$el.find("#geo-bias").val()):(b.mapDefinition.latfield=this.$el.find("#lat").val(),b.mapDefinition.lonfield=this.$el.find("#lon").val(),b.mapDefinition.lookupfields=null);b.mapDefinition.geolookup=this.$el.find("#geo-lookup").is(":checked");b.mapDefinition.metric=this.$el.find("#select-metric").val();
b.mapDefinition.search={};b.mapDefinition.search.street=this.$el.find("#street-lookups").val();b.mapDefinition.search.city=this.$el.find("#city-lookups").val();b.mapDefinition.search.county=this.$el.find("#county-lookups").val();b.mapDefinition.search.state=this.$el.find("#state-lookups").val();b.mapDefinition.search.country=this.$el.find("#country-lookups").val();b.hasProcessed=!1;c=b.mapDefinition.search;if(""!==c.street||""!==c.city||""!==c.county||""!==c.state||""!==c.country||null!==b.mapDefinition.latfield||
null!==b.mapDefinition.lonfield)"OSM"===Settings.MAPS_TYPE&&(c=new SaikuMapRenderer(this,a,b,"run_workspace_map"),c.renderMap()),null===b.mapDefinition.latfield&&null===b.mapDefinition.lonfield&&Saiku.ui.block("Loading map..."),this.workspace.query.setProperty("saiku.ui.map.options",b),this.workspace.query.setProperty("saiku.ui.render.mode","map"),this.workspace.query.setProperty("saiku.ui.render.type",a);this.$el.dialog("close")}}),Tour=Backbone.View.extend({initialize:function(a){_.bindAll(this,
"run_tour");_.extend(this,Backbone.Events);this.toolbar=a.toolbar},run_tour:function(){var a=this,b=[{content:"\x3cp\x3eClick here to open a new query.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$("#new_query"),my:"top left",at:"right bottom",setup:function(a,b){Saiku.events.bind("toolbar:new_query",this.onSelectKitten)},teardown:function(a,b){Saiku.events.unbind("toolbar:new_query",this.onSelectKitten)},bind:["onSelectKitten"],onSelectKitten:function(a,b,e,f){b.view=f;a.next()}},
{content:"\x3cp\x3eSelect the Foodmart Sales Cube\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".cubes"),my:"bottom center",at:"top center",setup:function(a,b){Saiku.events.bind("workspace:new_query",this.onSelectCube)},teardown:function(a,b){Saiku.events.unbind("workspace:new_query",this.onSelectCube)},bind:["onSelectCube"],onSelectCube:function(b,d,e,f){"Sales"===f.cube?(d.view=f.view,setTimeout(function(){a.exec||(a.exec=!0);b.next()},200)):$(".tour-container").html("\x3cp\x3eYou didn't select the Sales cube.\x3c/p\x3e")}},
{content:"\x3cp\x3eGreat, next we need to execute a query.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".dimension_tree"),my:"bottom center",at:"top center",setup:function(a,b){return{target:$(".dimension_tree")}}},{content:"\x3cp\x3eFirst lets expand the Customer dimension.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$('a[title\x3d"Customer"]'),my:"left center",at:"right center",setup:function(a,b){Saiku.events.bind("workspace:expandDimension",this.onExpandDimension);
return{target:$('a[title\x3d"Customer"]')}},bind:["onExpandDimension"],onExpandDimension:function(a,b,e,f){a.next()}},{content:"\x3cp\x3eGreat next drag the State Province level to the Rows dropzone.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".rows_fields"),my:"left center",at:"right center",setup:function(a,b){Saiku.events.bind("workspaceDropZone:select_dimension",this.onSelectLevel);$('a[title\x3d"State Province"]').addClass("tour-highlight");return{target:$(".rows_fields")}},
bind:["onSelectLevel"],onSelectLevel:function(a,b,e,f){"[Customer].[Customers]"===f.hierarchy&&"State Province"===f.level?a.next():$(".tour-container").html("\x3cp\x3eYou didn't select the correct level. Remove this one and replace it with the highlighted level.\x3c/p\x3e")}},{content:"\x3cp\x3eNext we'll add a measure. Drag Unit Sales into the Measures Drop Zone.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".rows_fields"),my:"left top",at:"right bottom",setup:function(a,b){Saiku.events.bind("workspaceDropZone:select_measure",
this.onSelectMeasure);return{target:$('a[title\x3d"[Measures].[Unit Sales]"]')}},bind:["onSelectMeasure"],onSelectMeasure:function(a,b,e,f){"Unit Sales"===f.measure.name?a.next():$(".tour-container").html("\x3cp\x3eYou didn't select the correct measure. Remove this one and replace it with the highlighted measure.\x3c/p\x3e")}},{content:"\x3cp\x3eGreat, we've now run a very basic query. Now we'll view it as a chart.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),
my:"bottom center",at:"top center",setup:function(a,b){return{target:$("div.table_wrapper")}}},{content:"\x3cp\x3eTo view your data as a chart, click on the chart icon.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".rows_fields"),my:"right center",at:"left center",setup:function(a,b){Saiku.events.bind("queryToolbar:render_chart",this.onClickChartIcon);return{target:$(".query_toolbar_vertical")}},bind:["onClickChartIcon"],onClickChartIcon:function(a,b,e,f){a.next()}},{content:"\x3cp\x3eYou can now select from the different chart type Saiku offers.\x3c/p\x3eSaiku Enterprise users can set chart properties by clicking on the properties button.\x3c/p\x3e\x3cp\x3eYou can also export your chart to a file by clicking on the Export button.\x3c/p\x3e",
